angular.module('watson')
    ...
    /*	ctrl.askQuestion = function(question) {
	   ...
	   ctrl.chatQuestion = function(question) {
    	    ...
    	    if (question in cannedResponses) {
                cannedAnswer = cannedResponses[question].pop();
            }
